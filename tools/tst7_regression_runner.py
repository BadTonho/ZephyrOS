...
QUICK_COMMANDS = (
    ...
    ("test-update-host", "update-host"),
    ("test-update-runtime-host", "update-runtime-host"),
    ("test-update-remote-runtime-host", "update-remote-runtime-host"),
    ("test-update-remote-host", "update-remote-host"),
    ("test-app-remote-host", "app-remote-host"),
    ("test-update-system-slots-host", "update-system-slots-host"),
    ("test-update-remote-system-host", "update-remote-system-host"),
    ("test-update-remote-github-host", "update-remote-github-host"),
    ("test-update-remote-release-host", "update-remote-release-host"),
    ("test-update-system-host", "update-system-host"),
    ("test-state-host", "state-host"),
    ("test-device-manager-host", "device-manager-host"),
    ("test-app-api-host", "app-api-host"),
    ("test-app-files-host", "app-files-host"),
    ("test-app-builtin-host", "app-builtin-host"),
    ("test-app-loader-host", "app-loader-host"),
    ("test-taskbar-host", "taskbar-host"),
    ("test-syscall-host", "syscall-host"),
    ...
    ("test-storage-fat32-host", "storage-fat32-host"),
    ...
    ("test-tls-client-host", "tls-client-host"),
    ("test-mediaplayer-host", "mediaplayer-host"),
    ("test-shell-job-host", "shell-job-host"),
    ("test-shell-pipeline-host", "shell-pipeline-host"),
    ("test-http-host", "http-host"),
    ("test-net-socket-host", "net-socket-host"),
    ("test-vma-host", "vma-host"),
    ("test-paging-host", "paging-host"),
    ("test-memory-host", "memory-host"),
    ("test-process-resource-host", "process-resource-host"),
    ("test-process-signal-host", "process-signal-host"),
    ("test-process-ipc-host", "process-ipc-host"),
    ("test-workqueue-host", "workqueue-host"),
    ("test-service-supervisor-host", "service-supervisor-host"),
    ...
    ("test-wifi-manager-host", "wifi-manager-host"),
    ("test-usb-manager-host", "usb-manager-host"),
    ("test-usb-hid-host", "usb-hid-host"),
    ("test-usb-msc-host", "usb-msc-host"),
    ("test-devfs-host", "devfs-host"),
    ("test-procfs-host", "procfs-host"),
    ("test-wav-host", "wav-host"),
    ("test-bmp-host", "bmp-host"),
    ("test-rng-host", "rng-host"),
    ("test-serial-host", "serial-host"),
    ("test-tss-host", "tss-host"),
    ("test-speaker-host", "speaker-host"),
    ("test-keyboard-host", "keyboard-host"),
    ("test-protocol-adapter-host", "protocol-adapter-host"),
    ("test-blackbox-host", "blackbox-host"),
    ("test-coverage-host", "test-coverage-host"),
    ...
    ("test-shell-diagnostics-helpers-host", "shell-diagnostics-helpers-host"),
...
HOST_CASE_TARGETS = {
    ...
    "host:core:update": "test-update-host",
    "host:core:update-runtime": "test-update-runtime-host",
    "host:core:update-remote-runtime": "test-update-remote-runtime-host",
    "host:core:update-remote": "test-update-remote-host",
    "host:core:app-remote": "test-app-remote-host",
    "host:core:update-system-slots": "test-update-system-slots-host",
    "host:core:update-remote-system": "test-update-remote-system-host",
    "host:core:update-remote-github": "test-update-remote-github-host",
    "host:core:update-remote-release": "test-update-remote-release-host",
    "host:core:update-system": "test-update-system-host",
    "host:core:state": "test-state-host",
    "host:core:device-manager": "test-device-manager-host",
    "host:core:app-api": "test-app-api-host",
    "host:core:app-files": "test-app-files-host",
    ...
    "host:process:resources": "test-process-resource-host",
    ...
    "host:storage:storage-fat32": "test-storage-fat32-host",
    ...
    "host:security:tls-client": "test-tls-client-host",
    "host:shell:mediaplayer": "test-mediaplayer-host",
    "host:shell:job": "test-shell-job-host",
    "host:shell:pipeline": "test-shell-pipeline-host",
    ...
    "host:core:service-supervisor": "test-service-supervisor-host",
    ...
    "host:core:wifi-manager": "test-wifi-manager-host",
    "host:core:usb-manager": "test-usb-manager-host",
    "host:drivers:usb-hid": "test-usb-hid-host",
    ...
    "host:drivers:serial": "test-serial-host",
    "host:drivers:tss": "test-tss-host",
    "host:drivers:speaker": "test-speaker-host",
    "host:drivers:keyboard": "test-keyboard-host",
    "host:tst2:protocol-adapter": "test-protocol-adapter-host",
    "host:tst5:blackbox": "test-blackbox-host",
    "host:core:test-coverage": "test-coverage-host",
