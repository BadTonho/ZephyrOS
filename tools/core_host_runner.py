...
APP_REMOTE_RESULT_DIR = ROOT / "build" / "test-results" / "app-remote-host"
APP_REMOTE_BINARY = ROOT / "build" / "tests" / "test_app_remote_host.exe"
...
SHELL_COMMANDS_APPS_RESULT_DIR = ROOT / "build" / "test-results" / "shell-commands-apps-host"
SHELL_COMMANDS_APPS_BINARY = ROOT / "build" / "tests" / "test_shell_commands_apps_host.exe"
...
SHELL_COMMANDS_APPS_SOURCE_FILES = (
    ROOT / "tests" / "unit" / "test_shell_commands_apps_host.c",
    ROOT / "src" / "shell" / "shell_commands_apps.c",
    ROOT / "src" / "core" / "string.c",
)
...
APP_REMOTE_SOURCE_FILES = (
    ROOT / "tests" / "unit" / "test_app_remote_host.c",
    ROOT / "src" / "core" / "app_remote.c",
    ROOT / "src" / "core" / "string.c",
)
...
UPDATE_REMOTE_RELEASE_RESULT_DIR = ROOT / "build" / "test-results" / "update-remote-release-host"
UPDATE_REMOTE_RELEASE_BINARY = ROOT / "build" / "tests" / "test_update_remote_release_host.exe"
UPDATE_REMOTE_RELEASE_SOURCE_FILES = (
    ROOT / "tests" / "unit" / "test_update_remote_release_host.c",
...
WM_RESULT_DIR = ROOT / "build" / "test-results" / "wm-host"
WM_BINARY = ROOT / "build" / "tests" / "test_wm_host.exe"
WM_SOURCE_FILES = (
...
PROCESS_RESULT_DIR = ROOT / "build" / "test-results" / "process-host"
PROCESS_BINARY = ROOT / "build" / "tests" / "test_process_host.exe"
...
TEST_COVERAGE_RESULT_DIR = ROOT / "build" / "test-results" / "test-coverage-host"
TEST_COVERAGE_BINARY = ROOT / "build" / "tests" / "test_coverage_host.exe"
TEST_COVERAGE_SOURCE_FILES = (
    ROOT / "tests" / "unit" / "test_coverage_host.c",
    ROOT / "src" / "core" / "test_coverage.c",
)
...
GUI_RESULT_DIR = ROOT / "build" / "test-results" / "gui-host"
GUI_BINARY = ROOT / "build" / "tests" / "test_gui_host.exe"
GUI_SOURCE_FILES = (
    ROOT / "tests" / "unit" / "test_gui_host.c",
    ROOT / "src" / "gui" / "gui.c",
    ROOT / "src" / "core" / "string.c",
)
...
ATA_RESULT_DIR = ROOT / "build" / "test-results" / "ata-host"
ATA_BINARY = ROOT / "build" / "tests" / "test_ata_host.exe"
ATA_SOURCE_FILES = (
...
VIDEO_RESULT_DIR = ROOT / "build" / "test-results" / "video-host"
VIDEO_BINARY = ROOT / "build" / "tests" / "test_video_host.exe"
VIDEO_SOURCE_FILES = (
...
UHCI_SOURCE_FILES = (
    ROOT / "tests" / "unit" / "test_uhci_host.c",
...
MOUSE_RESULT_DIR = ROOT / "build" / "test-results" / "mouse-host"
MOUSE_BINARY = ROOT / "build" / "tests" / "test_mouse_host.exe"
MOUSE_SOURCE_FILES = (
...
AC97_RESULT_DIR = ROOT / "build" / "test-results" / "ac97-host"
AC97_BINARY = ROOT / "build" / "tests" / "test_ac97_host.exe"
AC97_SOURCE_FILES = (
...
def case_configuration(case_id: str) -> tuple[Path, Path, tuple[Path, ...], str]:
    ...
    if case_id == "host:core:app-remote":
        return APP_REMOTE_RESULT_DIR, APP_REMOTE_BINARY, APP_REMOTE_SOURCE_FILES, "app-remote-host"
    ...
    if case_id == "host:shell:commands-apps":
        return (SHELL_COMMANDS_APPS_RESULT_DIR,
                SHELL_COMMANDS_APPS_BINARY,
                SHELL_COMMANDS_APPS_SOURCE_FILES,
                "shell-commands-apps-host")
    ...
    if case_id == "host:core:test-coverage":
        return (TEST_COVERAGE_RESULT_DIR, TEST_COVERAGE_BINARY,
                TEST_COVERAGE_SOURCE_FILES, "test-coverage-host")
