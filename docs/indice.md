...
- App API 0.6, descritores VFS, caminhos universais, cwd, syscalls, sinais, loader ZAPP e IPC
...
| [API de Aplicativos e Syscalls](melhorias%20futuras/api%20de%20aplicativos%20e%20syscalls.md) | Contrato 0.6, caminhos VFS, cwd, syscalls, sinais, argumentos e loader ZAPP ring 3 |
