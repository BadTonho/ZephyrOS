...
| [08 - Evolução da Plataforma](roadmaps/08-evolucao-da-plataforma.md) | EP1-EP6.4 implementadas; EP7.0 implementada para inventário PCI e diagnóstico seguro; driver Wi-Fi real e EP9 permanecem pendentes |
