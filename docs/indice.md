...
- App API 0.9, descritores VFS, devfs, pipes, redirecionamento, caminhos universais, cwd, ioctl, syscalls, sinais, loader ZAPP, VMA e IPC
...
| [API de Aplicativos e Syscalls](melhorias%20futuras/api%20de%20aplicativos%20e%20syscalls.md) | Contrato 0.9, devfs, pipes, redirecionamento, ioctl, caminhos VFS, cwd, sinais, argumentos, VMA e loader ZAPP ring 3 |
...
| [Inventario RLS2 do Shell](qualidade/rls2-inventario-shell.md) | Comandos, jobs, cenas, bloqueios e pontos de foco auditados pela RLS2 |
