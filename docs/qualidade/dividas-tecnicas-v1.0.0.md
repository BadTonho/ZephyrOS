...
| [Roadmaps 09](../roadmaps/09-funcionalidades-aplicaveis.md), [10](../roadmaps/10-vfs-e-abstracao-io.md), [11](../roadmaps/11-gerenciamento-avancado-de-memoria.md), [12](../roadmaps/12-concorrencia-e-sincronizacao.md) e [13](../roadmaps/13-armazenamento-e-buffer-cache.md) | R4-R9, VFS, MM, SYNC3-SYNC4 e BLK1-BLK4 ainda nao iniciados; SYNC2 aguarda perfis sem NIC e multi-NIC | Trabalho planejado ou validacao pendente, nao divida tecnica |
