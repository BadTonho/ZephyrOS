...
`api` usa `0.7` em pacotes novos; `0.3`, `0.4`, `0.5` e `0.6` continuam
...
O `app.json` precisa de `id`, `name` e `version`; `api` assume `0.7`, aceita
explicitamente `0.3`, `0.4`, `0.5` e `0.6` para pacotes legados e
...
0.4, 0.5, 0.6 e 0.7, corrupcao de CRC32 e injecao em uma imagem temporaria. `package-demo`
