# Explorer Classic — ZephyrOS

## Resumo de Progresso

- [x] Adicionar `FM_MODE_SIMPLE` e `FM_MODE_CLASSIC`.
- [x] Selecionar o modo pelo `guimode` global.
- [x] Criar layout Classic com janela, barra de ferramentas, endereço,
...
| Comando | Ação |
|---------|------|
| `guimode classic` | Ativa o visual Classic do Desktop e do Explorer |
| `guimode simple` | Restaura o visual TUI |
| `explorer` | Abre o Explorer usando o modo selecionado |

## Fases

### Fase 1 — Visual Classic do Explorer
...
- O modo Simple continua sendo o fallback para VESA ou backbuffer indisponível.
