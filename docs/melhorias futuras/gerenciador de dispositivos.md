...
## S1.1 - Inventario nativo seguro (concluida)
...
- [x] Validacao manual no QEMU concluida para a listagem compacta e verbosa,
  consulta por ID, re-scan PCI, `health` e fallbacks controlados.
