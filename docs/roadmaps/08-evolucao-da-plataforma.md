...
- [x] Limpeza do cache runtime v2 concluida, mantendo a instalacao `0.1.1`,
  o estado `READY` e o journal `CLEAN`, com o cache local ausente conforme
  esperado. Concluida em: 2026-08-23 00:35 (America/Sao_Paulo).
