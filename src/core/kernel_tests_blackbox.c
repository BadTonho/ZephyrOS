...
static int blackbox_is_perf6_case(const char* case_id,
                                  uint32_t case_length) {
    static const char case_name[] = "qemu:tst5:perf6-kworker-thread";
...
static const char* blackbox_marker(const char* case_id, uint32_t case_length) {
    ...
    if (blackbox_equals(case_id, case_length, shell4_case)) {
        return "shell4-apps-packages";
    }
    ...
    if (blackbox_equals(case_id, case_length, perf6_case)) {
        return "tst5-perf6-kworker-thread";
    }
