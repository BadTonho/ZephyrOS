...
typedef enum {
    ...
    RECOVERY_COMPONENT_ACPI,
    RECOVERY_COMPONENT_DEVICES,
    RECOVERY_COMPONENT_NETWORK,
    RECOVERY_COMPONENT_POWER,
    RECOVERY_COMPONENT_UPDATE,
    RECOVERY_COMPONENT_SYSTEM_UPDATER,
    RECOVERY_COMPONENT_APP_STORE,
    RECOVERY_COMPONENT_STORAGE,
    RECOVERY_COMPONENT_USB,
