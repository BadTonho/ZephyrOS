...
typedef enum {
    DEVICE_KIND_PCI = 0,
    DEVICE_KIND_ATA_PRIMARY,
    DEVICE_KIND_AC97,
    DEVICE_KIND_PS2_KEYBOARD,
    DEVICE_KIND_PS2_MOUSE,
    DEVICE_KIND_PIT,
    DEVICE_KIND_VGA_TEXT,
    DEVICE_KIND_VESA,
    DEVICE_KIND_PC_SPEAKER
} device_kind_t;
...
/* Texto e montado sob demanda para manter o snapshot estatico compacto. */
typedef struct {
