...
#define VFS_MAX_MOUNTS (VFS_MAX_STORAGE_MOUNTS + 3U)
#define VFS_MAX_PROCFS_ENTRIES 70U
#define VFS_MAX_DIR_ENTRIES \
    ((STORAGE_MAX_DIR_ENTRIES + 4U) > VFS_MAX_PROCFS_ENTRIES ? \
     (STORAGE_MAX_DIR_ENTRIES + 4U) : VFS_MAX_PROCFS_ENTRIES)
