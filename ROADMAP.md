...
Evolução da plataforma:      [████████████████----------------------------] EP1-EP4.2 validadas; EP4.3 em planejamento
```
...
| 8 | [`docs/roadmaps/08-evolucao-da-plataforma.md`](docs/roadmaps/08-evolucao-da-plataforma.md) | EP1-EP4.2 validadas; EP4.3 em planejamento. |
