...
static int check_valid_cases(void) {
    static const char* cases[HOST_CASE_COUNT][2] = {
        ...
        {"qemu:tst5:shell4-apps-packages", "shell4-apps-packages"},
        {"qemu:tst5:shell5-system-update", "shell5-system-update"},
        ...
        {"qemu:tst5:perf6-kworker-thread", "tst5-perf6-kworker-thread"},
        {"qemu:tst5:rls2-shell-liveness", "tst5-rls2-shell-liveness"},
        {"qemu:tst5:rls3-invariants", "tst5-rls3-invariants"}
    };
