...
$(ETHERNET_OBJ): $(ETHERNET_C) src/include/core/ethernet.h src/include/memory/slab.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
...
$(APP_API_OBJ): $(APP_API_C) src/include/core/app_api.h src/include/core/app_files.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
...
$(SYSCALL_OBJ): $(SYSCALL_C) src/include/core/syscall.h src/include/core/app_api.h src/include/core/app_files.h src/include/memory/paging.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
...
$(PROCESS_OBJ): $(PROCESS_C) src/include/process/process.h src/include/memory/slab.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
