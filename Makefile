...
$(KERNEL_OBJ): $(KERNEL_C) src/include/apps/shell_job.h src/include/core/keyboard.h src/include/core/input.h src/include/core/irq_deferred.h src/include/core/workqueue.h src/include/core/ethernet.h src/include/core/clock.h src/include/core/tls.h src/include/core/update_system.h src/include/core/update_system_slots.h src/include/core/update_remote_system.h src/include/drivers/rtc.h src/include/process/thread.h src/include/memory/slab.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
...
$(SLAB_OBJ): $(SLAB_C) src/include/memory/slab.h src/include/core/errors.h src/include/core/log.h src/include/core/memory.h src/include/core/spinlock.h src/include/core/string.h src/include/memory/paging.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
...
$(VFS_OBJ): $(VFS_C) src/include/fs/vfs.h src/include/core/poll.h src/include/fs/vfs_internal.h src/include/fs/devfs.h src/include/fs/procfs.h src/include/fs/storage.h src/include/process/process.h src/include/process/thread.h src/include/core/app_api.h src/include/core/wait.h src/include/memory/slab.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@

$(VFS_PATH_OBJ): $(VFS_PATH_C) src/include/fs/vfs.h src/include/fs/vfs_internal.h src/include/fs/devfs.h src/include/fs/procfs.h src/include/fs/storage.h src/include/process/process.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
...
$(BLOCK_CACHE_OBJ): $(BLOCK_CACHE_C) src/include/fs/block_cache.h src/include/fs/block.h src/include/core/errors.h src/include/core/log.h src/include/core/spinlock.h src/include/core/string.h src/include/core/wait.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@

$(STORAGE_OBJ): $(STORAGE_C) src/include/fs/storage.h src/include/fs/block_cache.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
...
$(SHELL_COMMANDS_CORE_OBJ): $(SHELL_COMMANDS_CORE_C) src/include/apps/shell.h src/include/apps/shell_dispatch.h src/include/apps/shell_command_utils.h src/include/apps/shell_pipeline.h src/include/apps/shell_runtime.h src/include/process/process.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
...
$(SHELL_COMMANDS_DIAGNOSTICS_OBJ): $(SHELL_COMMANDS_DIAGNOSTICS_C) src/include/apps/shell.h src/include/apps/shell_dispatch.h src/include/apps/shell_command_utils.h src/include/apps/shell_runtime.h src/include/core/input.h src/include/core/irq_deferred.h src/include/core/workqueue.h src/include/core/clock.h src/include/core/tls.h src/include/core/wifi_manager.h src/include/fs/vfs.h src/include/drivers/idt.h src/include/drivers/rtc.h src/include/drivers/usb_hid.h src/include/process/process.h src/include/memory/slab.h src/include/memory/vma.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
...
$(SHELL_CHECKS_OBJ): $(SHELL_CHECKS_C) src/include/apps/shell.h src/include/apps/shell_dispatch.h src/include/apps/shell_command_utils.h src/include/apps/shell_job.h src/include/apps/shell_runtime.h src/include/core/keyboard.h src/include/core/input.h src/include/core/irq_deferred.h src/include/core/workqueue.h src/include/core/clock.h src/include/core/tls.h src/include/core/wifi_manager.h src/include/drivers/idt.h src/include/drivers/rtc.h src/include/drivers/usb_hid.h src/include/process/process.h src/include/memory/vma.h
	@if not exist build mkdir build
	$(GCC) $(CFLAGS) -c $< -o $@
