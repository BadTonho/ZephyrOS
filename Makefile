...
test-storage-fat32-host: tools\core_host_runner.py tools\coverage_collector.py tests\unit\test_storage_fat32_host.c tests\catalog.json src\fs\storage.c src\include\fs\storage.h
